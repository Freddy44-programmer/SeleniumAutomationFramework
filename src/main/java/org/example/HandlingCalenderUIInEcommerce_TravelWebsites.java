...
public class HandlingCalenderUIInEcommerce_TravelWebsites {
    public static void main(String[] args) {
        ...
        driver.findElements(By.cssSelector(".react-calender__year-view__months__month")).get(Integer.parseInt(monthNumber)-1).click();
